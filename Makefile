...
mock: 
	...
	mockgen -destination worker/mock/distributor.go -package mockworker github.com/kien-ltt/simplebank/worker TaskDistributor
...
redis: 
	docker run --name redis-simple-bank-golang -p 6379:6379 -d redis:7-alpine

.PHONY: postgres createdb dropdb migratecreate migrateup migratedown migrateup1 migratedown1 db_docs db_schema sqlc test server mock proto evans redis
